...
This is a *mode* rather than a category: unlike everything in
:mod:`~resonator_name_generator.generator`, the order matters, nothing is drawn
at random, and there is no weighting to mix it with the word lists. ``R0003``
sitting between ``Rosalind`` and ``Stroopwafel`` would be neither one thing nor
the other.
"""
